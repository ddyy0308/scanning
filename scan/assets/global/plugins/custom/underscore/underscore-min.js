...
(function () {
    ...
    j.reduce = j.foldl = j.inject = function (n, t, r, e) {
        ...
        if (null == n && (n = [
        ]), h && n.reduce === h) return e && (t = j.bind(t, e)),
    ...
    j.reduceRight = j.foldr = function (n, t, r, e) {
        var u = arguments.length > 2;
        if (null == n && (n = [
        ]), v && n.reduceRight === v) return e && (t = j.bind(t, e)),
    ...
    j.pairs = function (n) {
        for (var t = j.keys(n), r = t.length, e = new Array(r), u = 0; r > u; u++) e[u] = [
            t[u],
            n[t[u]]
        ];
        return e
...
var u = new RegExp([(r.escape || q).source,
