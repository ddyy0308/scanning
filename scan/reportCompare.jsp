        ...
        <div class="row">
            <div class="page-bar col-md-12">
                <ul class="page-breadcrumb list-inline">
                    <li><i class="icon-docs"></i><span>{{msg.reportManager}}</span><i class="fa fa-angle-right"></i></li>
                    <li><span>{{msg.reportCenter}}</span><i class="fa fa-angle-right"></i></li>
                    <li><span>{{msg.compareReport}}</span></li>
                </ul>
            </div>
        </div>
        <div class="row b-min-height" ng-controller="reportCompareCtrl">
        </div>
    </div><!-- content-->
